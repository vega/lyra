...
var React = require('react'),
  ...
  mount = enzyme.mount,
  MultiValueProperty = require('./MultiValueProperty'),
  resetMarkVisual = require('../../actions/markActions').resetMarkVisual,
  wrapper;

describe('MultiValueProperty Inspector <MultiValueProperty/>', function () {
  var mockStore;
  ...
  describe('Basic input rendering', function () {
    it('renders a number input', function () {
      wrapper = mount(<MultiValueProperty name="x" label="X" type="number"
    ...
    it('renders a range input', function () {
      wrapper = mount(<MultiValueProperty name="opacity" label="Opacity" type="range"
    ...
    it('renders a color input', function () {
      wrapper = mount(<MultiValueProperty name="fill" label="Fill" type="color"
        disabled={true} />, {
        context: { store: mockStore({}) }
      });
    ...
    it('renders a text input', function () {
      wrapper = mount(<MultiValueProperty name="text" label="Text" type="text"
        disabled={true} />, {
        context: { store: mockStore({}) }
      });
    ...
    it('renders a checkbox input', function () {
      wrapper = mount(<MultiValueProperty name="band" label="Automatic" type="checkbox"
        disabled={true} />, {
        context: { store: mockStore({}) }
      });
    ...
    it('renders a select', function () {
      wrapper = mount(<MultiValueProperty name="orient" label="Orient" type="select"
  ...
  describe('Bound data', function () {
    ...
    it('renders a field', function () {
      ...
      wrapper = mount(<MultiValueProperty name="y" label="Y" type="number"
        primType="marks" primId="1" />, {
        context: { store: state }
      });
    ...
    it('renders a value', function () {
      wrapper = mount(<MultiValueProperty name="title" label="Text" type="text"
